# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-01-27 08:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investments', to='efsPortfolioApp.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stocks', to='efsPortfolioApp.Customer')),
            ],
        ),
    ]
